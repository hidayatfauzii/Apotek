...
Partial Class FrmCariObatBeli
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Klik pada salah satu daftar obat yang ada diatas untuk memilih !"
        '
        'bt_Cari
        '
        ...
        Me.Label14.Text = "Pencarian Obat"
